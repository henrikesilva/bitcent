...
export default function Slogan() {
    function renderizarFrase() {
        return (
            <div className={`
                flex flex-col items-center md:items-start text-4xl lg:text-6
                text-white font-light
            `}>
                <div className="flex gap-2.5">
                    <div className={`relative`}>
                        <span className={`
                            absolute bottom-1 left-9 w-full
                ...
                <div className="flex gap-2.5">
                    ...
                    <span className={`
                        ...
                        relative text-black
                    `}>
                        <span className="absolute -rotate-1 top-0.5 left-0 w-full h-5/6 bg-yellow-300 rouded-sm" />
        ...
        <div className="flex flex-col justify-center gap-5">
            ...
            <div className="flex justify-center sm:justify-start items-center gap-2">
                ...
                `}>
                    ...
                    <IconArrowRight className="hidden lg:inline" stroke={1}></IconArrowRight>
                </div>
                <div className={`
                    flex items-center gap-2 cursor-pointer
